...
class ParticleFilter {
 public:
  ...
  double calcWeight(const Map &map_landmarks, double norm, std::vector<LandmarkObs, std::allocator<LandmarkObs> > &obs, double variance_x_inv, double variance_y_inv);
 ...
 private:
  ...
  std::vector<class TaskQueue*> taskQueues;
};
